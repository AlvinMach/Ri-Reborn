...
const Register = () => {
  ...
  return (
    ...
    className = "bg-white shadow-lg flex justify-center flex-col items-center  py-6 h-[800px] max-w-[800px] mt-11 mx-auto container">
        ...
        <input type = "submit" value = "Register"  className = "bg-gray-500 hover:bg-gray-400 mt-6 px-6 py-2 w-[300px] rounded-xl  font-semibold" />
        <p className = "text-lg mt-6">Already registered ?<Link className = "text-red-400 hover:text-red-500 px-2" to = "/login">Sign up here</Link></p>
    </form>
    </>
  );
};
